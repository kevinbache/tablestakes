...
class OptimizersMaker(torch_mod.Parametrized['OptimizationMaker.OptParams']):
...
class FactoredLightningModule(pl.LightningModule, torch_mod.Parametrized[torch_mod.PS]):
